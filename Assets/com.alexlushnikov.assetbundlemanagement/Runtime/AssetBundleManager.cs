...
namespace AssetBundleManagement
{
    public class AssetBundleManager : MonoBehaviour
    {
        ...
        {
            var bundleVersionURL = ServerConfig.GetWithDomain("/AssetBundles/BundleVersion.json");
        ...
        private IEnumerator DownloadAssetBundleFromServerAsync(string assetBundleName, Action onSuccess,
            ...
            Action<string> onError)
        {
            var bundleURL = ServerConfig.GetServerPath(assetBundleName);
        ...
        {
            var platformFolder = ServerConfig.GetPlatformFolder();
